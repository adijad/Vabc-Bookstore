...
public class CustomerDaoJdbc implements CustomerDao {
    ...
    public long create(Connection connection,
        ...
        try (PreparedStatement statement =
            ...
            java.sql.Date timestamp = new java.sql.Date(ccExpDate.getTime());
            ...
            System.out.println("SQLException caught (CustomerJDBC): " + e.getMessage());
    ...
    public Customer findByCustomerId(long customerId) {
        ...
        try (Connection connection = getConnection();
            ...
            System.out.println("[CustomerDaoJdbc] Exception: " + e.getMessage());
